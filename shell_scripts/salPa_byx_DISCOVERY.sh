...
if du -hac -d 1 /dartfs-hpc/scratch/f002bx6/salmon/$2/$1/salmon/quant.sf ; then
    echo "/salmon/$2/$1 already processed"
    DT=$(date)
    echo "Attempt $SLURM_JOB_ID $DT" >> /dartfs-hpc/scratch/f002bx6/salmon/$2/$1/processes.log
...
DT=$(date)
echo "Processed $SLURM_JOB_ID $DT" > /dartfs-hpc/scratch/f002bx6/salmon/$2/$1/processes.log
