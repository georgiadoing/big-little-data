...
write.csv(filt_run_table, "SraRunTable_Ec_04_29_25_FILTEREDv3.csv")
...
write.csv(ec_run_table_out, "SraRunTable_Ec_04_29_25_working_v3_part2.csv")
```
...
write.csv(ec_counts_norm, 'compendia/ecoli_pan_genome_clean_norm_part2.csv', row.names = F)
write.csv(ec_log_counts_norm, 'compendia/ecoli_pan_genome_clean_norm_log_part2.csv', row.names = F)
write.csv(ec_counts_norm_t, 'compendia/ecoli_pan_genome_trimmed_clean_norm_part2.csv', row.names = F)
write.csv(ec_log_counts_norm_t, 'compendia/ecoli_pan_genome_trimmed_clean_norm_log_part2.csv', row.names = F)
...
write.csv(ec_log_counts_norm_01, 'compendia/ecoli_pan_genome_part2_log_counts_norm_01_nonames.csv', row.names = F)
write.csv(ec_log_counts_norm_01, 'compendia/ecoli_pan_genome_part2_log_counts_norm_01.csv', row.names = T)

write.csv(ec_log_counts_norm_t_01, 'compendia/ecoli_pan_genome_part2_trimmed_log_counts_norm_01_nonames.csv', row.names = F)
write.csv(ec_log_counts_norm_t_01, 'compendia/ecoli_pan_genome_part2_trimmed_log_counts_norm_01.csv', row.names = T)
```
